...
export const metadata: Metadata = {
  ...
  description: "Link masuk sudah dikirim ke email kamu.",
};
...
const mobileParticles = [
  { x: "20%", y: "18%", s: 5, glow: true, pd: "5s", po: ".3", pt: "0s" },
    ...
    <>
      <style>{`
        ...
        @media (min-width: 768px) and (max-width: 1199px) {
          ...
          .login-form h1 { font-size: 26px !important; margin-bottom: 8px !important; }
          .login-form .lead { font-size: 14px !important; margin-bottom: 12px !important; }
          .login-form .email-badge { padding: 8px 18px !important; font-size: 13px !important; margin-bottom: 12px !important; }
          .login-form .btn { height: 44px !important; font-size: 14px !important; }
          ...
          <div className="mob-login-full">
            ...
            <div className="mob-login-sent-card">
              ...
              <p className="lead" style={{ 
                ...
                Kami sudah kirim link masuk ke:
              </p>
              <div className="email-badge" style={{
                display: "inline-block",
                padding: "10px 20px",
                borderRadius: "var(--r-full)",
                background: "var(--tw-secondary-soft)",
                fontFamily: "var(--f-body)",
                fontWeight: 600,
                fontSize: 14,
              ...
              <div style={{ 
                ...
                Salah alamat? <Link href="/login" style={{ color: "var(--tw-primary)", fontWeight: 700, textDecoration: "none" }}>Ganti email</Link>
              </div>
            </div>
      ...
      <div className="vp-desktop">
        <div className="login-wrap-v2">
          <div className="login-left-v2">
            ...
            <div className="tab-only-particle login-fi-dark" style={{ top: "18%", left: "10%" }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>
            </div>
            <div className="tab-only-particle login-fi-dark lav" style={{ bottom: "22%", right: "10%" }}>
            ...
            <div className="tab-only-particle login-fi-dark warm" style={{ top: "60%", left: "14%" }}>
            ...
            <div className="login-form login-sent" style={{ 
              ...
              <div className="icn" style={{ 
                ...
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ display: "block" }}>
                  <rect x="3" y="5" width="18" height="14" rx="2" />
                  <path d="m3 7 9 6 9-6" />
                </svg>
              </div>
              ...
              <p className="lead" style={{ 
                ...
                Klik link di email untuk masuk. Link berlaku 15 menit.
              </p>
            ...
            <div className="tab-only-quote" style={{ position: "absolute", bottom: 32, left: 0, right: 0, textAlign: "center", zIndex: 10, padding: "0 40px" }}>
              <h3 style={{ fontFamily: "var(--f-title)", fontWeight: 700, fontSize: 18, color: "var(--tw-primary-soft)", margin: "0 0 4px", letterSpacing: "-0.2px" }}>Sambil menunggu — tarik napas.</h3>
              <p style={{ fontFamily: "var(--f-body)", fontSize: 13, color: "rgba(245,239,228,.4)", margin: 0 }}>Link masuk biasanya sampai dalam 30 detik.</p>
            </div>
          </div>
          <div className="login-right-v2">
            ...
            <div className="login-right-quote">
              <h3>Sambil menunggu — tarik napas.</h3>
              <p>Link masuk biasanya sampai dalam 30 detik.</p>
            </div>
          </div>
        </div>
