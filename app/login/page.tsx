      ...
      <div className="vp-desktop">
        <div className="login-wrap-v2">
          <div className="login-left-v2">
            ...
            <div className="tab-only-particle login-fi-dark" style={{ top: "15%", left: "8%" }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>
            </div>
            <div className="tab-only-particle login-fi-dark lav" style={{ bottom: "20%", right: "8%" }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /></svg>
            </div>
            <div className="tab-only-particle login-fi-dark warm" style={{ top: "65%", left: "12%" }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>
            </div>

            {/* Tablet-only stat nodes */}
            <div className="tab-only-particle login-stat-node" style={{ top: "10%", right: "10%" }}>
              <div className="sn-label">Bulan ini</div>
              <div className="sn-val">32 sesi</div>
              <div className="sn-sub">+6 dari Mei</div>
            </div>
            <div className="tab-only-particle login-stat-node" style={{ bottom: "12%", left: "10%" }}>
