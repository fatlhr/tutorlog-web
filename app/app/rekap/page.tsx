...
// Dummy data persis dari design/web-screens.jsx (data wiring = Task 4.3)
const rows = [
...
// Dummy data persis dari design/web-mobile-screens.jsx
const groups = [
  { date: "28 Jun", items: [
          ...
          <div className="mob-app-shell">
            <div className="mob-app-main">
              ...
              <div className="mob-export-bar">
                <button type="button" className="mob-export-btn"><IcDownload size={14} /><span>CSV</span></button>
